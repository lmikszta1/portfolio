...
export default function ProjectCard({ title, gitLink, liveLink, imgLink, hrefLink, description }){
    return (
        <>
            <Card variant="outlined" sx={{width: 320, padding: 1}} className="transition ease-in-out delay-100 bg-slate-400 hover:-translate-y-1 hover:scale-110 hover:bg-slate-200 duration-200" >
                <div>
                    <h2 className='font-roboto text-md font-semibold'>{title}</h2>
                    <p className='font-roboto text-sm text-center'>{description}</p>
