    ...
    return (
        <div className='slideInUp'>
            ...
            <main className="flex max-h-screen min-h-screen flex-col items-center justify-start p-10 gap-5 font-roboto text-center">
                <p className="text-slate-300 text-6xl slideInUp delay-300" >Blackjack!</p>
                <p className="text-slate-200 text-2xl mt-4 slideInUp delay-200">Blackjack web application built using vanilla Javascript, HTML and CSS. Click the links below to see the GitHub repo for the project and the live website!</p>
