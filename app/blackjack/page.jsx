    ...
    return (
        <div className='slideInUp'>
            ...
            <main className="flex max-h-screen min-h-screen flex-col items-center justify-start p-10 gap-5 font-roboto text-center">
                <p className="text-slate-300 text-3xl lg:text-6xl slideInUp delay-300" >Blackjack!</p>
                <p className="text-slate-200 text-lg lg:text-2xl mt-4 slideInUp delay-200">Blackjack web application built using vanilla Javascript, HTML and CSS. Click the links below to see the GitHub repo for the project and the live website!</p>
                ...
                <div className='w-full max-w-6xl h-[250px] slideInUp delay-0 lg:h-[1000px]'>
                    <Carousel>
                        ...
                        <img alt="third" src="https://camo.githubusercontent.com/5e520030c08cebb338dea05c5b118b016e7ee6026c1c152848411f61f971c1a7/68747470733a2f2f692e696d6775722e636f6d2f753432436a35432e706e67"/>
                        <img alt="fourth" src="https://camo.githubusercontent.com/139920fc72cf980e2abaf621955cb843b1c2b49b292e5f55ff54a4ad9e19064a/68747470733a2f2f692e696d6775722e636f6d2f34724975566d432e706e67"/>
                        <img alt="fifth" src="https://camo.githubusercontent.com/a405776838795e4d2b40c3fd57d2209cf2b64213a052d32126aa2642b523bd55/68747470733a2f2f692e696d6775722e636f6d2f48424c383734632e706e67"/>
                    </Carousel>
                </div>
            </main>
        </div>
