    ...
    return (
        <div className='slideInUp'>
            ...
            <main className="flex max-h-screen min-h-screen flex-col items-center justify-start p-10 gap-5 font-roboto text-center">
                <p className="text-slate-300 text-3xl lg:text-6xl slideInUp delay-300" >PillPal</p>
                <p className="text-slate-200 text-lg lg:text-2xl mt-4 slideInUp delay-200">Introducing our Django-powered group project — a user-friendly web application developed in just one week. Seamlessly track your medications and check stock at nearby pharmacies. Simplify your health management with our intuitive interface, designed to empower users. Join us in revolutionizing medication management for everyone!</p>
